...
const PD = {
  ...
  18: { t: "Agentic AI News Pipeline", c: "independent", l: "Personal Project", p: "Personal Project", d: "Agentic workflow that automatically sources, contextualises, and delivers daily AI news updates, integrated with X and Hashnode to publish it automatically.", b: ["Built using <strong>LangChain</strong> for multi-step agentic reasoning", "Automatically scrapes and contextualises daily AI news from multiple sources", "Look for the authenticity of the News", "Write blog and tweets to post and publish in X and HashNode"], g: ["LangChain", "Agentic AI", "Grok", "Automation", "Tavily", "PlayWright"], gh: "https://github.com/rohitpaul23/PolyPulse", blog: "https://medium.com/p/408358f2aa60?postPublishedType=initial" },
  19: { t: "WebGL Real-Time Lip-Sync", c: "independent", l: "Personal Project", p: "Personal Project", d: "Browser-based real-time lip-sync using WebGL, plus a video creation automation pipeline using Remotion.", b: ["WebGL-based real-time lip-sync rendering in the browser", "Video creation automation pipeline using <strong>Remotion</strong>", "Designed for low-latency performance in live interactive contexts"], g: ["WebGL", "Remotion", "JavaScript", "Real-Time", "Video Generation"] },
...
const PACC = { alethia: "linear-gradient(90deg,#14b8a6,#6366f1)", dressme: "linear-gradient(90deg,#818cf8,#c084fc)", independent: "linear-gradient(90deg,#c084fc,#818cf8)" };
const PCOL = { alethia: "#14b8a6", dressme: "#818cf8", independent: "#c084fc" };
const PTAG = { alethia: "pct-alethia", dressme: "pct-dressme", independent: "pct-independent" };
const PLAB = { alethia: "Alethia AI", dressme: "DressMe AI", independent: "Independent" };
...
function openPM(id) {
  ...
  if (p.gh) {
    const label = p.gh.includes('github.com/') ? p.gh.split('github.com/')[1] : 'View Code';
    h += `<a href="${p.gh}" target="_blank" class="pm-link"><div class="pm-link-ico">💻</div><div class="pm-link-meta"><div class="pm-link-type">GitHub</div><div class="pm-link-label">${label}</div></div><span style="font-size:.75rem;color:#52525b">↗</span></a>`;
  } else {
  ...
  if (p.blog) {
    h += `<a href="${p.blog}" target="_blank" class="pm-link"><div class="pm-link-ico">✍️</div><div class="pm-link-meta"><div class="pm-link-type">Blog / Write-up</div><div class="pm-link-label">Read Case Study</div></div><span style="font-size:.75rem;color:#52525b">↗</span></a>`;
  } else {
